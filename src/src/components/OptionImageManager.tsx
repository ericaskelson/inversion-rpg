  ...
  return (
    <div className="option-image-manager">
      ...
      <div className="generation-actions">
        ...
        >
          {isCreatingBatch ? 'Creating...' : `Create Batch Job (${selectedOptions.size})`}
        </button>
      </div>
          ...
          return (
            <div key={categoryId} className="category-section">
              ...
              >
                ...
                <span className="category-count">({options.length} options)</span>
              </div>
                  ...
                  {options.map(opt => {
                    ...
                    return (
                      ...
                      >
                        ...
                        {opt.isDrawback && <span className="drawback-badge">Drawback</span>}
                      </div>
                    );
                  })}
                </div>
